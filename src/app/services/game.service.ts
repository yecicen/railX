...
export class GameService {
  ...
  playerScore: number = 0;
	...
	detectCrash(obstacle: Obstacles )  {
      ...
      window.document.getElementById('score').innerHTML =  this.playerScore.toString();
		}
	}
